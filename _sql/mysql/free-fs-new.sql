...
CREATE TABLE `file_transfer_task`  (
  ...
  `replaced_file_id` varchar(128) NULL DEFAULT NULL COMMENT '被替换的文件ID（用于同名文件替换场景）',
...
INSERT INTO `sys_role` VALUES (100016, '01kpq1bqzq1z99r0vd2xxqr3yk', 'department_admin', '部门管理员', '可管理本部门空间、成员权限、查看操作日志及存储空间', 0, '2026-04-21 11:29:22', '2026-04-21 11:29:22');
INSERT INTO `sys_role` VALUES (100017, '01kpq1bqzq1z99r0vd2xxqr3yk', 'member', '普通员工', '可进行文件上传、下载、预览、分享等日常操作，可查看文件版本历史', 0, '2026-04-21 11:29:22', '2026-04-21 11:29:22');
INSERT INTO `sys_role` VALUES (100018, '01kpq1bqzq1z99r0vd2xxqr3yk', 'viewer', '受限成员', '仅可浏览、预览与下载', 0, '2026-04-21 11:29:23', '2026-04-21 11:29:23');
...
INSERT INTO `sys_role_permission` VALUES (54, 100016, 'department_admin', 'file:read');
INSERT INTO `sys_role_permission` VALUES (55, 100016, 'department_admin', 'file:write');
INSERT INTO `sys_role_permission` VALUES (56, 100016, 'department_admin', 'file:share');
INSERT INTO `sys_role_permission` VALUES (57, 100016, 'department_admin', 'storage:manage');
INSERT INTO `sys_role_permission` VALUES (58, 100016, 'department_admin', 'member:manage');
INSERT INTO `sys_role_permission` VALUES (59, 100017, 'member', 'file:read');
INSERT INTO `sys_role_permission` VALUES (60, 100017, 'member', 'file:write');
INSERT INTO `sys_role_permission` VALUES (61, 100017, 'member', 'file:share');
INSERT INTO `sys_role_permission` VALUES (62, 100018, 'viewer', 'file:read');
